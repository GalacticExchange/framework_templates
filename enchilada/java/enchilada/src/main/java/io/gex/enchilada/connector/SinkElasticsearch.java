...
public class SinkElasticsearch implements Sink {
    ...
    SinkElasticsearch(String topic, String name) throws Exception {
        ...
        this.propertiesFilePath = Paths.get(Enchilada.configDir, name + "-elasticsearch.properties").toString();
        this.url = Enchilada.properties.getProperty(PropertiesReader.ELASTICSEARCH_URL);
        this.index = Enchilada.properties.getProperty(PropertiesReader.ELASTICSEARCH_INDEX);
        checkConfig();
    }
