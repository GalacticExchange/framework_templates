data = {
    ...
    "kafka.host" => { description: "Kafka host", default_value: "{{kafka.broker}}", mandatory: 0, editable: 1},
    ...
    "kudu.master_host" => { description: "Kudu master host", default_value: "{{kudu.master_host}}", mandatory: 0, editable: 1},
    "kudu.master_port" => { description: "Kudu master port", default_value: "7051", mandatory: 0, editable: 1},
}
