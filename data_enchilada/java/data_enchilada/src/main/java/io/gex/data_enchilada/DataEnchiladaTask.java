...
import io.gex.data_enchilada.connector.Sink;
...
class DataEnchiladaTask {

    private final static Logger logger = LogManager.getLogger(DataEnchiladaTask.class);
    ...
    static Map<String, DataEnchiladaTask> tasks = new HashMap<>();
    ...
    private DataEnchiladaTask(Connector connector) {
    ...
    static void add(Connector connector) {
        ...
        DataEnchiladaTask task = new DataEnchiladaTask(connector);
        task.start();
    ...
    private Logger createLogger() {
        ...
        if (!LogManager.exists(topic)) {
            ...
            String logFilename = "/data/data_enchilada/connectors/log/" + topic + ".log";
            ...
            LoggerConfig loggerConfig = LoggerConfig.createLogger(false, Level.INFO, "io.gex.data_enchilada.connector",
